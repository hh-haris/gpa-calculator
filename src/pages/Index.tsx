  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-inter transition-all duration-300">
      <div className="container mx-auto px-4 py-4 sm:py-8 max-w-5xl">
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1 flex flex-col items-center">
              <motion.h1 
                className="text-lg sm:text-xl md:text-2xl font-bold text-[#000000] dark:text-white font-jakarta mb-2"
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
        ...
        >
          <div className="bg-[#EEEEEE] dark:bg-gray-700 p-1 rounded-lg inline-flex w-full max-w-md relative overflow-hidden shadow-lg">
            ...
            <Button
              ...
              className={`flex-1 py-2 px-4 rounded-md font-inter transition-all text-sm sm:text-base relative z-10 ${
                activeTab === 'gpa'
                  ...
                  : 'bg-transparent text-[#979797] hover:text-[#000000] dark:hover:text-white hover:scale-102'
              }`}
              variant="ghost"
            >
              GPA Calculator
